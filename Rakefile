...
begin
  ...
  Jeweler::Tasks.new do |gemspec|
    ...
    gemspec.description = "A gem for James Turnbull's resume"
    gemspec.email = "james@lovedthanlost.net"
    gemspec.homepage = "http://github.com/jamtur01/jamtur01.github.com"
    gemspec.authors = ["James Turnbull"]
